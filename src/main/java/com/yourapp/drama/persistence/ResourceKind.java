...
public enum ResourceKind {
    ...
    NOVEL_UPLOAD_SESSION("novel_upload_session", "novel-upload-sessions", null, null),
    NOVEL_SOURCE("novel_source", "novel-sources", null, null),
    ...
    NOVEL_INTELLIGENCE_RUN("novel_intelligence_run", "novel-intelligence-runs", null, null),
    ...
    public boolean immutable() { return this == STORY_FACT_MUTATION || this == CHARACTER_KNOWLEDGE || this == PROMPT_VERSION || this == COST_RECORD || this == PRICE_SNAPSHOT || this == HUMAN_EDIT_FEEDBACK || this == QC_RESULT
            ...
            || this == NOVEL_STORY_ARC || this == NOVEL_STORY_GRAPH || this == EPISODE_ADAPTATION_PLAN; }

...
public class NovelAdaptationController {
    private final NovelAdaptationService adaptations;private final NovelAdaptationContextAssembler contexts;
    public NovelAdaptationController(NovelAdaptationService adaptations,NovelAdaptationContextAssembler contexts){this.adaptations=adaptations;this.contexts=contexts;}

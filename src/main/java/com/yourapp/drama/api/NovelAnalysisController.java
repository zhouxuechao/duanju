...
public class NovelAnalysisController {
    private final NovelAnalysisService analysis;private final NovelIndexService index;private final NovelEntityResolutionService entities;
    public NovelAnalysisController(NovelAnalysisService analysis,NovelIndexService index,NovelEntityResolutionService entities){this.analysis=analysis;this.index=index;this.entities=entities;}
    @GetMapping("/analysis/estimate") public ObjectNode estimate(@PathVariable String novelId){return analysis.estimate(novelId);}

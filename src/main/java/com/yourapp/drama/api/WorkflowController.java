...
import com.yourapp.drama.workflow.CostEstimator;
...
public class WorkflowController {
    ...
    @PostMapping("/projects/{id}/cost-estimate") public ObjectNode costEstimate(@PathVariable String id,@RequestBody ObjectNode b){return costEstimator.estimate(id,b);}
    ...
    @PostMapping("/shots/{id}/previs")public ObjectNode previs(@PathVariable String id,@RequestBody(required=false)ObjectNode b){return workflow.image(id,"STORYBOARD",body(b));}

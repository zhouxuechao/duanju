...
public final class VolcengineImageGenerator implements ImageGenerator {
    ...
    @Override public ImageResult generate(ImageRequest request) {
        ...
        body.put("model", properties.getImageModel()); body.put("prompt", request.prompt()); body.put("response_format", "url");
        ...
        return new ImageResult(url, expires, response.requestId(), properties.getImageModel(), false);
    }
}

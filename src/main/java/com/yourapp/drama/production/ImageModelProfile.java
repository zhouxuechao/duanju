...
public record ImageModelProfile(
        ...
        List<String> supportedSizes,String defaultSize,List<String> supportedRatios,
    ...
    public ImageModelProfile {supportedSizes=List.copyOf(supportedSizes);supportedRatios=List.copyOf(supportedRatios);}
    public ObjectNode toJson(){
        ...
        ArrayNode sizes=value.putArray("supportedSizes");supportedSizes.forEach(sizes::add);ArrayNode ratios=value.putArray("supportedRatios");supportedRatios.forEach(ratios::add);return value;
    }

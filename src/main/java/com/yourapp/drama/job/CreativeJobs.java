...
public class CreativeJobs {
    private final StoryDevelopmentService development;private final StoryQualityService storyQuality;private final DirectorGenerationService director;
    public CreativeJobs(StoryDevelopmentService development,StoryQualityService storyQuality,DirectorGenerationService director){this.development=development;this.storyQuality=storyQuality;this.director=director;}

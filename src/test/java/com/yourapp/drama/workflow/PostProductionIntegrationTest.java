...
class PostProductionIntegrationTest {
    @Autowired DocumentStore store;@Autowired PostProductionService post;@Autowired WorkflowService workflow;@Autowired GenerationWorker worker;@Autowired MediaStorage media;@Autowired AssetViewService assetViews;@Autowired StudioService studio;

...
class ProductionBoundaryDeterministicRuleTest {
    ...
    private final ProductionBoundaryDeterministicRule rule=new ProductionBoundaryDeterministicRule();
    ...
    @Test void continuousShotRequiresAnAcceptedPreviousTake(){
        ObjectNode context=mapper.createObjectNode();context.putObject("shot").put("duration",4).put("relationToPrevious","CONTINUOUS");
        context.putObject("previousTake").put("selected",true).put("locked",false).put("qcPassed",true);
    ...
    @Test void acceptedEndMustMatchTheNextStartIncludingScreenDirection(){
        ObjectNode context=mapper.createObjectNode(),shot=context.putObject("shot");shot.put("duration",4).put("relationToPrevious","CONTINUOUS");

...
class H2UpgradePathTest {
    @Test void upgradesV1ToV37(){assertUpgrade("v1-to-v37","1");}
    @Test void upgradesV16ToV37(){assertUpgrade("v16-to-v37","16");}
    @Test void upgradesV28ToV37(){assertUpgrade("v28-to-v37","28");}
    private void assertUpgrade(String database,String startingVersion){
        ...
        assertThat(current.info().current().getVersion().getVersion()).isEqualTo("37");
    }
}

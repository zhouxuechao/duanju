...
class H2UpgradePathTest {
    @Test void upgradesV1ToV26(){assertUpgrade("v1-to-v26","1");}
    @Test void upgradesV16ToV26(){assertUpgrade("v16-to-v26","16");}
    private void assertUpgrade(String database,String startingVersion){
        ...
        assertThat(current.info().current().getVersion().getVersion()).isEqualTo("26");
    }
}

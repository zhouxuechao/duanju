...
class H2UpgradePathTest {
    @Test void upgradesV1ToV31(){assertUpgrade("v1-to-v31","1");}
    @Test void upgradesV16ToV31(){assertUpgrade("v16-to-v31","16");}
    @Test void upgradesV28ToV31(){assertUpgrade("v28-to-v31","28");}
    private void assertUpgrade(String database,String startingVersion){
        ...
        assertThat(current.info().current().getVersion().getVersion()).isEqualTo("31");
    }
}

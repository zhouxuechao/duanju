...
class H2UpgradePathTest {
    @Test void upgradesV1ToV32(){assertUpgrade("v1-to-v32","1");}
    @Test void upgradesV16ToV32(){assertUpgrade("v16-to-v32","16");}
    @Test void upgradesV28ToV32(){assertUpgrade("v28-to-v32","28");}
    private void assertUpgrade(String database,String startingVersion){
        ...
        assertThat(current.info().current().getVersion().getVersion()).isEqualTo("32");
    }
}
